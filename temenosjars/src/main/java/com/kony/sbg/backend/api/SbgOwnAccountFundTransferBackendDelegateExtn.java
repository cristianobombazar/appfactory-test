...
/**
 * Handles all backend operations on OwnAccount Fund transaction
 * @author KH2624
 * extends {@link BackendDelegate}
 */

public interface SbgOwnAccountFundTransferBackendDelegateExtn extends OwnAccountFundTransferBackendDelegate {
