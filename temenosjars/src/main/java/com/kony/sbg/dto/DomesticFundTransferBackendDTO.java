...
public class DomesticFundTransferBackendDTO extends TransferDTO implements DBPDTO {
    ...
    public DomesticFundTransferBackendDTO() {
    }

    public DomesticFundTransferBackendDTO(String transactionId, String dbxtransactionId, String isScheduled, String featureActionId, String transactionType, String companyId, String transactionCurrency, String fromAccountCurrency, String frequencyType, String frequencyTypeId, String fromAccountNumber, String toAccountNumber, double amount, String transactionsNotes, String notes, String transactionts, String frequencyEndDate, String numberOfRecurrences, String scheduledDate, String serviceName, String deliveryDate, String processingDate, String recipientId, String accountCode, String nickName, String fromAccountType, String day1, String day2, String toAccountType, String name, String numberOfPayments, String message, String frequency, String question, String answer, String checkBackImage, String accountHolderNumber, String payeeName, String profileId, String cardNumber, String cardExpiry, String transferLocator, String transferId, String paymentId, String noofRecurrences, String payeName, String iban, String swiftCode, String bicCode, String bankName, String bankId, String feeCurrency, String beneficiaryName, String paidBy, String paymentType, String feeAmount, String beneficiaryAddressNickName, String beneficiaryAddressLine1, String beneficiaryCity, String beneficiaryId, String payeeId, String beneficiaryZipcode, String beneficiarycountry, String validate, String overrides, String charges, String exchangeRate, String totalAmount, String serviceCharge, String convertedAmount, String transactionAmount, String status, String overrideList, String creditValueDate, String intermediaryBicCode, String clearingCode, String beneficiaryBankName, String beneficiaryAddressLine2, String beneficiaryPhone, String beneficiaryEmail, String beneficiaryState, String paymentStatus) {
        this.iban = iban;
    ...
    public DomesticFundTransferBackendDTO convert(DomesticFundTransferDTO dto) {
        super.convert(dto);
    ...
    public String toString() {
        return "DomesticFundTransferBackendDTO{" +
                "iban='" + iban + '\'' +
                ", bicCode='" + bicCode + '\'' +
                ", bankName='" + bankName + '\'' +
                ", bankId='" + bankId + '\'' +
