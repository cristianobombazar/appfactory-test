...
public class FetchPreBookedDeals implements JavaService2 {

	private static final Logger LOG = Logger.getLogger(FetchPreBookedDeals.class);
	@Override
			...
			DataControllerResponse response) throws Exception 
	{
		...
		try {
			...
			result = resource.fetchPreBookedDeals(javaInputParams,request);
			LOG.info("FetchPreBookedDeals Result:" + result.toString());
		} catch (Exception exp) {
