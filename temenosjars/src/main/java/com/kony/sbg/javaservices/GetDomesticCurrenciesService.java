...
public class GetDomesticCurrenciesService implements JavaService2 {
	...
	public Object invoke(String methodID, Object[] inputArray, DataControllerRequest dcRequest,
		...
		try {
			...
			result = resource.getDomesticCurrencies(methodID, inputArray, dcRequest, dcResponse);
			LOG.info("GetDomesticCurrenciesService Result::" + result.toString());
		} catch (Exception exp) {
			LOG.error("Error in GetDomesticCurrenciesService: " + exp.getMessage());
