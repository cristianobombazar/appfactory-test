...
public interface DomesticFundTransferResource extends Resource {
    ...
    Result cancelScheduledTransactionOccurrence(String var1, Object[] var2, DataControllerRequest var3, DataControllerResponse var4);
