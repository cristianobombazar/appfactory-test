...
public interface SbgDomesticFundTransferResourceExtn extends DomesticFundTransferResource, Resource {

    /**
     * creates DomesticFund transaction after validating the limits and puts into approval queue if required
     * @param methodID
     * @param inputArray
     * @param request
     * @param response
	...
	**/
	...
	/** DomesticFundTransfer post processor this is hooked on the line of business service to
    ...
    /**
     * Edits a Domestic fund transaction after validating the limits and puts into approval queue if required
     * @param methodID
     * @param inputArray
     * @param request
     * @param response
